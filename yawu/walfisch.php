...
<body>
    ...
    <div class="main">
        ...
        <div id="quickAccesses">
            <div class="widthMaintainer /access-cards">
                ...
                <div class="container">
                    <h2 class="text-green fw-bold student-name">COST 231 Walfisch-Ikegami Path Loss Calculation</h2>
                    <hr>
                        <br>
                    ...
                    <label for="base_station_height">Base Station Height (m):</label>
                    <input type="number" id="base_station_height" required>
    ...
    <script>
        ...
        function calculatePathLoss() {
            ...
            var baseStationHeight = parseFloat(document.getElementById('base_station_height').value);

            if (isNaN(frequency) || isNaN(distance) || isNaN(baseStationHeight)) {
                alert('Please enter valid numerical values.');
                return;
            }

            // COST 231 Walfisch-Ikegami Path Loss Constants
            var A = 21.0;
            var B = 40.0;
            var C = 20.0;
            ...
            // Calculate COST 231 Walfisch-Ikegami Path Loss
            var pathLoss = A + B * Math.log10(frequency) - C * Math.log10(baseStationHeight) +
                           20 * Math.log10(distance_m);

            // Display the result on the page
            var resultElement = document.getElementById('result');
            resultElement.textContent = 'COST 231 Walfisch-Ikegami Path Loss: ' + pathLoss.toFixed(2) + ' dB';
